...
class TridentDataModule(LightningDataModule):
    ...
    def __init__(
        ...
        self.dataset_train_idx: Optional[Union[Dataset, dict[str, Dataset]]] = None
        self.dataset_val_idx: Optional[Union[Dataset, dict[str, Dataset]]] = None
        self.dataset_test_idx: Optional[Union[Dataset, dict[str, Dataset]]] = None
        self.dataset_predict_idx: Optional[Union[Dataset, dict[str, Dataset]]] = None
    ...
    def _remove_unused_columns(
        ...
        import inspect
        if not hasattr(self, "_signature_columns"):
            # Inspect model forward signature to keep only the arguments it accepts.
            if isinstance(self.trainer.model, DeepSpeedEngine):
                import pudb
                pu.db
            else:
